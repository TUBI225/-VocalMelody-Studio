...
| JUCE | 8.0.15, commit `91ad83ae34a81e0833b1a2b0866f54846370ae53` | Application Windows, UI, audio et MIDI futurs | Obligatoire pour l'application, pas pour le domaine commun | Double licence AGPLv3 ou JUCE commerciale | https://github.com/juce-framework/JUCE | `FetchContent` avec SHA-256 ; la CI précharge l'archive avec cinq nouvelles tentatives et fournit son URI locale | 2026-08-17 |
| minimp3 | commit `ea99364f61c14656440e8d77e9c233ccf3124633`, SHA-256 `5628166eb82a9bb581317918a334c317a2c0a30278bb14a20381307976768f34` | Décodage MP3 isolé dans `vocalmelody::audio` | Actif pour MP3 | CC0 | https://github.com/lieff/minimp3 | `FetchContent` épinglé ; la CI précharge l'archive avec cinq nouvelles tentatives et fournit son URI locale | 2026-08-17 |
