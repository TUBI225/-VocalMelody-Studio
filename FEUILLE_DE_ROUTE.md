...
- [FUSIONNÉ PR #9, CI VERTE] durcir `AudioImportOutcome` avec un état exclusif `std::variant` et tester toutes les erreurs déclenchables par entrée/annulation ;
- [FUSIONNÉ PR #9, CI VERTE] déplacer l'import sur un worker annulable avec progression par étape ;
- [FUSIONNÉ PR #9, CI VERTE] propager `Common` dans les interfaces CMake publiques de Frontend/Pitch et compiler deux consommateurs dédiés ;
