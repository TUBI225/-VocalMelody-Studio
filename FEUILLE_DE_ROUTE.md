...
- tests CTest `pitch.structures` et `pitch.autocorrelation` (8/8 au total), build et clang-format verts ; socle fusionné dans `main`, correction T-102.1 en validation.
